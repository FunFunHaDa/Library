...
namespace Library
{
    public partial class Form2 : Form
    {
        ...
        private void Naver(string query)
        {
            ...
            request.Headers.Add("X-Naver-Client-Id", "7B7ZBRncemF89HOiM3bg"); // 클라이언트 아이디
            request.Headers.Add("X-Naver-Client-Secret", "EoePoz9XIT");       // 클라이언트 시크릿
        ...
        private void Daum(string input)
        {
            ...
            string rkey = "bd6bbd53670d781854b556816a517421";
